...
class CardAdsPositionModel extends Model
{
    protected $name = 'card_ads_position';
    ...
    {
        try{
            $result =  $this->validate('CardAdsPositionValidate')->allowField(true)->save($param);
            if(false === $result){
    ...
    {
        try{
            $result =  $this->validate('CardAdsPositionValidate')->allowField(true)->save($param, ['id' => $param['id']]);
            if(false === $result){
